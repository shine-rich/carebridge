...
def init_state() -> None:
    ...
    treatment_plan_defaults = {
        ...
        "treatment_plan_data": {
            "case_summary": "Student struggles with social anxiety, especially in group settings.",
            "goals": "Build confidence in peer interactions, participate in one social activity weekly",
            "interventions": "Role-playing exercises, join support group, counselor-led exposure hierarchy",
            "coping_strategies": "Positive self-talk, focus shifting, grounding object",
            "followups": "Weekly check-in for 1 month"
        },
        "client_data": {
    ...
    for key, value in {**chat_defaults, **core_defaults, **clinical_defaults, **case_defaults, **treatment_plan_defaults}.items():
